...
ALARM_PATH := vendor/jos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/jos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/jos/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/jos/prebuilt/common/media/audio/ui
